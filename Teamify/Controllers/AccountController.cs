...
namespace Teamify.Controllers
{
    ...
    public class AccountController : BaseController
    {
        ...
        public AccountController(ApplicationDbContext dbContext, ApplicationSignInManager signInManager, ApplicationUserManager userManager,
            IAuthenticationManager authenticationManager) : base(dbContext)
        {
        ...
        //{
        //    public ChallengeResult(string provider, string redirectUri, IAuthenticationManager authenticationManager, string userId = null)
        //    {
