...
namespace Teamify.Controllers
{
    ...
    public class ManageController : BaseController
    {
        ...
        public ManageController(ApplicationDbContext dbContext, ApplicationUserManager userManager, ApplicationSignInManager signInManager, IAuthenticationManager authenticationManager) : base(dbContext)
        {
